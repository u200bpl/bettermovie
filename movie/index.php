<?php
    ...
    <?php foreach(array_slice($recentmovielist, 0) as $movie) { ?>
        <section class="hero" style="background-image: url(<?php echo $base_url; ?>/style/img/movies/<?php echo $movie['banner']; ?>.jpg);">
            <div class="heroinformation">
            <img src="<?php echo $base_url; ?>/style/img/logos/<?php echo $movie['banner']; ?>-logo.png" alt="<?php echo $movie['title']; ?> img banner">
                <p><?php echo $movie['description']; ?></p>
                <a class="btn" href="watch.php?id=<?php echo $movie['id']; ?>"><i class="heroicon fa-solid fa-video"></i> Play</a>
            ...
            <?php foreach(array_slice($recentmovielist, 0, 15) as $movie ) {?>
                ...
                <div class="movie-container">
                    <div class="movie-list2">
                        <a href="<?php echo $base_url; ?>/movie/watch.php?id=<?php echo $id;?>"><img src="<?php echo $base_url; ?>/style/img/movies/<?php echo $movie['banner']; ?>.jpg" alt="<?php echo $movie['title']; ?> img banner"></a>
                        <div class="overlay">                               
